...
#
# In the methods containing # TODO: your code here write the Active Record code that will produce the same result without causing an N+1 query. There are no skeleton projects provided: you will have to carefully think through the effects of what you write.
