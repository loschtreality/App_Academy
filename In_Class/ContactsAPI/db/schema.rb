...
ActiveRecord::Schema.define(version: 20161003225657) do
  ...
  add_index "comments", ["commentee_type", "commentee_id"], name: "index_comments_on_commentee_type_and_commentee_id"
